...
/*引脚配置*/
#define OLED_W_SCL(x)		GPIO_WriteBit(GPIOA, GPIO_Pin_3, (BitAction)(x)) //根据实际修改
#define OLED_W_SDA(x)		GPIO_WriteBit(GPIOB, GPIO_Pin_13, (BitAction)(x))//根据实际修改
...
void OLED_I2C_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3;  //根据实际修改
 	GPIO_Init(GPIOA, &GPIO_InitStructure);     //根据实际修改
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13; //根据实际修改
 	GPIO_Init(GPIOB, &GPIO_InitStructure);     //根据实际修改
